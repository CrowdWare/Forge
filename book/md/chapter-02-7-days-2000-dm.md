...
Some lessons arrive dramatically.
Mine arrived as a simple calculation.
...
But the Amiga was still on my desk.
And Deluxe Paint had shown me something I couldn't unsee.

So I signed up for an evening course at the Volkshochschule.
60 hours. C programming. Basics.
...
The feeling when I received the money was not excitement.
...
Permission to take seriously what I had always taken seriously in private.
Permission to call myself a developer when someone asked what I did.
Permission to stop pretending that the respectable path was my path.
...
Not everyone receives it so clearly.
Not everyone receives it so early.
...
The lesson was not in the publication.
The lesson was in the proof.

I had built something real.
Someone had paid real money for it.
...
- Feel the pull before you understand it *(Deluxe Paint)*
- Build the thing that won't leave you alone *(Sprite Editor)*
- Trust the proof when it arrives *(2000 DM)*
- Follow the logic wherever it leads *(leave Maschinenbau)*

This pattern has repeated itself throughout my entire life.

Forge followed the same pattern.
ForgeSTA followed the same pattern.
...
The pattern belongs to something larger.
